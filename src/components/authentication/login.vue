<template>
  ...
  >
    <div
      class="w-3/5 h-full pt-10 pb-16 bg-primaryColor flex justify-center items-center"
    >
      <div>
        <div class="mb-10 text-white">
          ...
          <p class="font-light text-xl">
            ...
            <router-link to="/signup" class="underline decoration-solid"
              >أنشئ حساب
            </router-link>
          </p>
        </div>
        <form>
          <div class="">
            <label for="eamil " class="font-light text-md text-white"
            ...
            />
            <label for="password" class="font-light text-md text-white"
              >كلمة المرور</label
            >
            <input
              type="password"
          ...
          <div class="flex flex-col justify-center items-center mb-3">
            <button
              class="bg-blue-500 text-primaryColor rounded-lg py-2 w-full font-bold"
            >
              سجل الدخول
            </button>
...
<script setup>
import FormComponent from "../contact/formComponent.vue";
</script>
